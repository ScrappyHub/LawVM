...
# Hard reset common poisoned vars (safe if absent)
Remove-Variable RepoRoot, PacketsPsm1, FsPsm1, Need, n, L, fixText, patchBody, selfText, selfPath, SelfPath, SelfText -ErrorAction SilentlyContinue

$RepoRoot = (Resolve-Path -LiteralPath $RepoRoot).Path
$ScriptsDir = Join-Path $RepoRoot "scripts"
EnsureDir $ScriptsDir

# Write scripts\self_test_v1.ps1 deterministically
